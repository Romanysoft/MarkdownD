        ...
        var  versionList = [
            {
                ...
                zipList:[
                    ...
                    {osUrl:linuxUrl,name:"MarkdownD-v2.2.0-ia32.tar.gz", size:"40.1MB", downURL:"http://pan.baidu.com/s/1o7ofrAy"},
                    {osUrl:linuxUrl,name:"MarkdownD-v2.2.0-x64.tar.gz", size:"40.1MB", downURL:"http://pan.baidu.com/s/1ntU46hz"},
                ]
            }
        ];        
